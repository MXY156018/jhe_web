    ...
    <el-container :class="[isSider?'openside':'hideside',isMobile ? 'mobile': '']">
      ...
      <el-aside class="main-cont main-left">
        <div class="tilte" :style="{background: backgroundColor}">
          <img alt class="logoimg" src="../../assets/logo_login1.jpg">
          <h2 v-if="isSider" class="tit-text" :style="{color:textColor}">後台管理</h2>
        </div>
        <Aside class="aside" />
      </el-aside>
      <!-- 分块滑动功能 -->
              ...
              <el-col>
                <el-header class="header-cont">
                  <el-row class="pd-0">
                    ...
                    <el-col :xs="12" :lg="14" :md="14" :sm="9" :xl="14" :pull="1">
                    ...
                    <el-col :xs="10" :lg="9" :md="9" :sm="14" :xl="9">
                      <div class="right-box">
                        <Search />
