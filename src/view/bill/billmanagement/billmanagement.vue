        ...
        <el-col class="left-row" :span="9" :offset="1">
          <div>
            <el-row style="height: 100px; line-height: 100px">
              ...
              <el-col :span="12">
                <p style="font-size: 25px; color: #8f8f8f">
                  {{ platformSumProfit }} JHE
                </p>
              </el-col>
            </el-row>
          </div>
        ...
        <el-tab-pane label="遊戲盈利記錄" name="fourth">
          ...
          >
            ...
            <el-table-column align="center" label="遊戲盈利記錄" min-width="50">
              <template #default>10 JHE</template>
            </el-table-column>
          </el-table>
          <div class="gva-pagination">
            <el-pagination
...
<script>
import { getTable, getGame, getDailyBill, getSumProfit } from "@/api/bill";
